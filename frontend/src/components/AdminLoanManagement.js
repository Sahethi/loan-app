        ...
        <table class="table table-striped">
            <thead>
                ...
                loans.map((loan,idx)=>(
                    ...
                    <td>
                        <button className='btn btn-primary text-white'><Link className='editBtn text-white' to={"/adminEditLoan/"+loan.loan_id}>Edit</Link></button><br></br>
                        <button className='btn btn-primary text-white' onClick={deleteLoan(loan.loan_id)}>Delete</button>
                    </td>
                    </tr>
                ))
                }
